 ...
 * Deformable-3D-Gaussians research group,
...
RasterizeGaussiansCUDA(
    ...
    const int image_width, const torch::Tensor& sh,
    const torch::Tensor& sh_objs, const int degree, const torch::Tensor& campos,
...
RasterizeGaussiansBackwardCUDA(
    ...
    const torch::Tensor& dL_dout_objects, const torch::Tensor& sh_objs,
